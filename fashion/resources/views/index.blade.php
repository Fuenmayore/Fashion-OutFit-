	...
	<div class="header-top">
		<div class="container">
				<div class="col-sm-4 logo animated wow fadeInLeft" data-wow-delay=".5s">
					<h1><a href="/">Fashion <span>Out Fit</span></a></h1>	
				</div>
			...
			<div class="col-sm-2 number animated wow fadeInRight" data-wow-delay=".5s">
					<span><i class="glyphicon glyphicon-phone"></i>(5)3792586</span>
					<p>Call me</p>
				</div>
								...
								<div class="dropdown-menu mega-dropdown-menu">
									<div class="container-fluid">
										...
										<div class="tab-content">
										  <div class="tab-pane active" id="men">
											<ul class="nav-list list-inline">
												<li><a href="men"><img src="images/t10.jpg" class="img-responsive" alt=""/></a></li>
												<li><a href="men"><img src="images/t2.jpg" class="img-responsive" alt=""/></a></li>
												<li><a href="men"><img src="images/t3.jpg" class="img-responsive" alt=""/></a></li>
												<li><a href="men"><img src="images/t4.jpg" class="img-responsive" alt=""/></a></li>
												<li><a href="men"><img src="images/t5.jpg" class="img-responsive" alt=""/></a></li>
												<li><a href="men"><img src="images/t6.jpg" class="img-responsive" alt=""/></a></li>
											</ul>
										  </div>
...
<div class="dropdown-menu mega-dropdown-menu">
   <div class="container-fluid">
	   ...
	   <div class="tab-content">
		 <div class="tab-pane active" id="men">
		   <ul class="nav-list list-inline">
			   <li><img src="images/niño1.jpg" width="150" height="150"  alt=""/></li>
			   <li><img src="images/niño2.jpg" width="150" height="150"  alt=""/></li>
															   <li><img src="images/niño3.jpg" width="150" height="150"  alt=""/></li>
			   <li><img src="images/niño4.jpg"  width="150" height="150"  alt=""/></li>
			   <li><img src="images/niño5.jpg"  width="150" height="150"  alt=""/></li>
			   <li><img src="images/niño6.jpg"  width="150" height="150"  alt=""/></li>
		   </ul>
		 </div>
...
<div class="dropdown-menu mega-dropdown-menu">
   <div class="container-fluid">
	   ...
	   <div class="tab-content">
		 <div class="tab-pane active" id="men">
		   <ul class="nav-list list-inline">
			   <li><img src="images/accesorio1.jpg" width="150" height="150"  alt=""/></li>
			   <li><img src="images/accesorio2.jpg" width="150" height="150"  alt=""/></li>
															   <li><img src="images/accesorio3.jpg" width="150" height="150"  alt=""/></li>
			   <li><img src="images/accesorio4.jpg"  width="150" height="150"  alt=""/></li>
			   <li><img src="images/accesorio5.jpg"  width="150" height="150"  alt=""/></li>
			   <li><img src="images/accesorio6.jpg"  width="150" height="150"  alt=""/></li>
		   </ul>
		 </div>
		...
		<div class="content-top">
			<div class="content-top1">
				...
				<div class="col-md-6 animated wow fadeInDown animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;"> 
                                    <center> <img src="images/Fashion.gif" width="300" height="300"/></center>
	...
	<div class="container">
		...
		<div class="container">
				...
				<div class="col-md-3 footer-bottom-cate cate-bottom animated wow fadeInRight" data-wow-delay=".5s">
					<h6>Our Address</h6>
					<ul>
						<li><i class="glyphicon glyphicon-map-marker" aria-hidden="true"></i>Address : Barranquilla, Atlántico</li>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i>Email : <a href="mailto:FashionOutFit@gmail.com">FashionOutFit@gmail.com</a></li>
						<li><i class="glyphicon glyphicon-earphone" aria-hidden="true"></i>Phone :(5)3792586</li>
                                                <li><i class="glyphicon glyphicon-search" aria-hidden="true"></i>Instagram: <a href="https://www.instagram.com/">Fashion_OutFit</a></li>
                                                <li><i class="glyphicon glyphicon-search" aria-hidden="true"></i>Facebook: <a href="https://www.facebook.com/">Fashion Out Fit</a></li>
                                           
					</ul>
				</div>
				<div class="clearfix"> </div>
				<p class="footer-class animated wow fadeInUp animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;"> © 2016 Fashion Out Fit . All Rights Reserved | Design by <a href="http://w3layouts.com/" target="_blank">W3layouts</a> </p>
			</div>
	</div>
</div>
<!--footer-->
